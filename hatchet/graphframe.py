    ...
    def from_spotdb(db_key, list_of_ids=None):
        ...
        Args:
            db_key (str or SpotDB object): locator for SpotDB instance
                (.sqlite filename or MySQL locator), or SpotDB object
            
            list_of_ids: The list of runs to read from the database.
                If this is None, returns all runs.
        
        Returns:
            A list of graphframes, one for each of the requested runs.
        """
