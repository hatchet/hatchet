 ...
 *   cdef long ref_pnid = parent_nid
 */
  __pyx_tuple__20 = PyTuple_Pack(8, __pyx_n_s_nid, __pyx_n_s_parent_nid, __pyx_n_s_metrics, __pyx_n_s_num_stmt_nodes, __pyx_n_s_stride, __pyx_n_s_ref_nid, __pyx_n_s_ref_pnid, __pyx_n_s_i); if (unlikely(!__pyx_tuple__20)) __PYX_ERR(0, 8, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__20);
  __Pyx_GIVEREF(__pyx_tuple__20);
  __pyx_codeobj__21 = (PyObject*)__Pyx_PyCode_New(5, 0, 8, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__20, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_reader_modules_pyx, __pyx_n_s_subtract_exclusive_metric_vals, 8, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__21)) __PYX_ERR(0, 8, __pyx_L1_error)
