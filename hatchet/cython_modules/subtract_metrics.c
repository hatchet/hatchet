...
static PyObject *__pyx_pw_16subtract_metrics_3subtract_exclusive_metric_vals(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("subtract_exclusive_metric_vals (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_parent_nid)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("subtract_exclusive_metric_vals", 1, 5, 5, 1); __PYX_ERR(0, 21, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_metrics)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("subtract_exclusive_metric_vals", 1, 5, 5, 2); __PYX_ERR(0, 21, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_num_stmt_nodes)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("subtract_exclusive_metric_vals", 1, 5, 5, 3); __PYX_ERR(0, 21, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_stride)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("subtract_exclusive_metric_vals", 1, 5, 5, 4); __PYX_ERR(0, 21, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "subtract_exclusive_metric_vals") < 0)) __PYX_ERR(0, 21, __pyx_L3_error)
      }
    ...
    __pyx_v_nid = __Pyx_PyInt_As_long(values[0]); if (unlikely((__pyx_v_nid == (long)-1) && PyErr_Occurred())) __PYX_ERR(0, 21, __pyx_L3_error)
    __pyx_v_parent_nid = __Pyx_PyInt_As_long(values[1]); if (unlikely((__pyx_v_parent_nid == (long)-1) && PyErr_Occurred())) __PYX_ERR(0, 21, __pyx_L3_error)
    __pyx_v_metrics = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_metrics.memview)) __PYX_ERR(0, 21, __pyx_L3_error)
    __pyx_v_num_stmt_nodes = __Pyx_PyInt_As_long(values[3]); if (unlikely((__pyx_v_num_stmt_nodes == (long)-1) && PyErr_Occurred())) __PYX_ERR(0, 21, __pyx_L3_error)
    __pyx_v_stride = __Pyx_PyInt_As_long(values[4]); if (unlikely((__pyx_v_stride == (long)-1) && PyErr_Occurred())) __PYX_ERR(0, 21, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("subtract_exclusive_metric_vals", 1, 5, 5, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 21, __pyx_L3_error)
  __pyx_L3_error:;
 ...
 *       ref_pnid += stride
 */
    __pyx_t_4 = (__pyx_v_ref_pnid - 1);
    if (__pyx_t_4 < 0) __pyx_t_4 += __pyx_v_metrics.shape[0];
    __pyx_t_5 = (__pyx_v_ref_nid - 1);
 ...
 *   global np_nids_memview
 */
  __pyx_tuple__21 = PyTuple_Pack(8, __pyx_n_s_nid, __pyx_n_s_parent_nid, __pyx_n_s_metrics, __pyx_n_s_num_stmt_nodes, __pyx_n_s_stride, __pyx_n_s_ref_nid, __pyx_n_s_ref_pnid, __pyx_n_s_i); if (unlikely(!__pyx_tuple__21)) __PYX_ERR(0, 21, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__21);
  __Pyx_GIVEREF(__pyx_tuple__21);
  __pyx_codeobj__22 = (PyObject*)__Pyx_PyCode_New(5, 0, 8, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__21, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_subtract_metrics_pyx, __pyx_n_s_subtract_exclusive_metric_vals, 21, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__22)) __PYX_ERR(0, 21, __pyx_L1_error)
 ...
 *   global np_nids_memview
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_16subtract_metrics_3subtract_exclusive_metric_vals, NULL, __pyx_n_s_subtract_metrics); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 21, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_subtract_exclusive_metric_vals, __pyx_t_1) < 0) __PYX_ERR(0, 21, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
